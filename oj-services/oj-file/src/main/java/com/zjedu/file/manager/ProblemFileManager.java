        ...
        for (Long pid : pidList)
        {
            ...
            futureTasks.add(new FutureTask<>(new Callable<Void>()
            {
                ...
                public Void call() throws Exception
                {
                    ...
                    ExportProblemParamsDTO params = new ExportProblemParamsDTO();
                    params.setProblemCaseList(problemCases);
                    params.setLanguageMap(languageMap);
                    params.setTagMap(tagMap);
                    ImportProblemVO importProblemVo = problemFeignClient.buildExportProblem(pid, params);
