...
import com.zjedu.judge.judge.entity.JudgeDTO;
import com.zjedu.judge.judge.entity.JudgeGlobalDTO;
import com.zjedu.judge.judge.entity.LanguageConfig;
import com.zjedu.judge.judge.task.DefaultJudge;
import com.zjedu.judge.judge.task.InteractiveJudge;
import com.zjedu.judge.judge.task.SpecialJudge;
import com.zjedu.judge.judge.task.TestJudge;
import com.zjedu.judge.util.Constants;
import com.zjedu.judge.util.JudgeUtils;
import com.zjedu.judge.util.ThreadPoolUtils;
...
//            final String testCaseOutputPath = testCasesDir + File.separator + outputFileName;
            ...
            while (iterator.hasNext())
            {
                        ...
                        && percentage != null && percentage > 0.0))
                {
                    ...
                    while (iterator.hasNext())
                    {
                        ...
                        JSONObject elseJudgeRes = getEntries(elseJudgeDTO, groupNum, judgeDTO);
    ...
    private static JSONObject getEntries(JudgeDTO elseJudgeDTO, Integer groupNum, JudgeDTO judgeDTO)
    {
    ...
    private AbstractJudge getAbstractJudge(Constants.JudgeMode judgeMode)
    {
        return switch (judgeMode)
        {
            ...
            default -> throw new RuntimeException("The problem judge mode is error:" + judgeMode);
        };
    }
