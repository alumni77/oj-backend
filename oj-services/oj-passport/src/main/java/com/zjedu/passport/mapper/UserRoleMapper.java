...
public interface UserRoleMapper extends BaseMapper<UserRole>
{
    ...
    IPage<UserRolesVO> getAdminUserList(Page<UserRolesVO> page, int limit, int currentPage, String keyword);

    IPage<UserRolesVO> getUserList(Page<UserRolesVO> page, int limit, int currentPage, String keyword);
}
